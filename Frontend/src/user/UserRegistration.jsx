...
const UserRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    const response = await registerUser(formData.fullName, formData.email, formData.password, formData.phoneNumber)
        ...
        <div className="col-12 col-sm-8 col-md-6 col-lg-4">
          <div
            ...
            style={{
              ...
              borderRadius: "25px", // Increased border-radius for a "round square" look
            }}
          >
